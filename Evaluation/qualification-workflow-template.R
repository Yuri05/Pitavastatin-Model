...
#' 
library(PMXRenv)
#install.unqualified.packages('ospsuite.reportingengine')
...
createQualificationReport("C:/Users/johanna/Documents/qualificationrunner-portable-setup_11.1.130/QualificationRunner 11.1.130", pkSimPortableFolder ="C:/Program Files/Open Systems Pharmacology/PK-Sim 11.2", createWordReport = FALSE)
